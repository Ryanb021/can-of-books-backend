...
await Books.create({
  title: 'The Dark Knight',
  img: 'https://w0.peakpx.com/wallpaper/113/52/HD-wallpaper-the-dark-knight-rises.jpg',
  description: 'Justice and Vengeance! Hero that we deserve!',
  status: 'true'
});
...
await Books.create({
  title: 'S is for Hope',
  img: 'https://i0.wp.com/batman-news.com/wp-content/uploads/2013/05/Superman-Man-of-Steel-Logo-Imgur.jpeg?w=1920&quality=80&strip=info&ssl=1',
...
await Books.create({
  title: 'Killing Joke',
  img: 'https://i.kym-cdn.com/entries/icons/original/000/003/189/Why_So_Serious_Banner.jpg',
